...
| :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ----------------------------------- |
| **Processing** | 1\. Build structured prompt with constraints (see CLAUDE.md prompt template) 2\. Call Claude claude-sonnet-4-20250514 via Anthropic API 3\. Parse structured JSON response 4\. Validate each project has: title, description, skills_addressed, difficulty, estimated_hours 5\. On LLM failure: return top-3 cached fallback projects from projects_cache.json |
